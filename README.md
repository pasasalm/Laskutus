...
- tarvikkeiden hintojen tarkastelu ja muuttaminen
...
- Tietokantayhteys: PHP:n pg\_\* API
...
8. Tarkastele ja päivitä tarvikkeiden hintoja
   - Sivu: uusi_hinnasto.php
   - Valitse hinnasto ja päivitä tarvikkeiden hinnat, tarkastele muutoksia ja nykyisiä tarvikehintoja
