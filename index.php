    ...
    <div class="container">
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="file_name1.php">Lisää työkohde</a></li>
                <li><a href="file_name2.php">Lisää tapahtuma</a></li>
                <li><a href="hinta_arvio.php">Hinta-arvio</a></li>
                <li><a href="file_name3.php">Luo lasku</a></li>
                <li><a href="file_name4.php">Näytä tiedot</a></li>
            </ul>
        </nav>

        <main class="content">
            <h2>Tervetuloa Tmi Sähkötärskyyn</h2>
